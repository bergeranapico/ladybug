# Import frontend for VISA communication
...
# IP-Adresse des zu testenden Geräts
IP = '192.168.1.151'

#Seriennummer Ladybug-Sensor eingeben
ser_lb = '177465'
# Leistungspegel Signalgenerator [dBm] oder 'min' bzw. 'max' eingeben:
# (Zahlen ohne Apostroph eingeben, 'min' oder 'max' mit Apostroph!)
power = 15
# Anzahl Frequenzschritte
steps = 50
# Anzahl Mittelungen vom LB5940L
ave = 1
#------------------------------------------------------------------
...
freq = np.linspace(f_low, f_high, steps)
